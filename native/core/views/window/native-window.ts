  ...
  implements NSToolbarDelegate, NSSearchFieldDelegate
{
  ...
  // toolbarItems: Array<NSToolbarItem> = [];
  ...
  //   _flag: boolean
  // ): NSToolbarItem {
  //   return this.toolbarItems.find((item) => item.itemIdentifier === itemIdentifier)!;
  ...
  //   return this.toolbarItems.map((item) => item.itemIdentifier) as any;
  // }
